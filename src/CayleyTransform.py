...
class CayleyTransform:
    ...
    def plot_spectrum(self, k = 15, save=False, figname='spectrum.png', path='./img/'):
        """
    ...
    def plot_transformed_spectrum(self, k = 15, save=False, figname='cayley_spectrum.png', path='./img/'):
        """
